...
for method in list_methods:
   ...
   for i in range(1,10):
      ...
      if not os.path.exists('./configs/exps/{}_wr/{}'.format(model,method)):
         try:
            os.makedirs('./configs/exps/{}_wr'.format(model))
         except:
            pass
         os.makedirs('./configs/exps/{}_wr/{}'.format(model,method))
      with open('./configs/exps/{}_wr/{}/{}.yaml'.format(model,method,dataset), 'w') as f:
